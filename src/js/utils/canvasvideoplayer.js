var CanvasVideoPlayer = function(options) {
	...
	this.video = this.options.video || document.querySelectorAll(this.options.videoSelector)[0];
	this.canvas = this.options.canvas || document.querySelectorAll(this.options.canvasSelector)[0];
